...
export default function Home() {
  ...
  // Static Gallery Data
  const galleryItems = [
    { id: 1, category: "football", title: "MPL 5th Edition Final Match", img: "/mpl-champ.jpeg" },
    { id: 2, category: "cricket", title: "Winter Short Pitch Tournament", img: "/short-pitch.jpeg" },
    { id: 3, category: "social", title: "Yearly Shikkhabritti Distribution", img: "/britti.jpeg" },
    { id: 4, category: "football", title: "Post-Eid Reunion Mini Cup", img: "/eid-post.jpeg" },
    { id: 5, category: "social", title: "Emergency Medical Relief Support", img: "/blood.jpeg" }, // Ager blood image jure deya holo
    { id: 6, category: "badminton", title: "Badminton Memories", img: "/badminton.jpeg" }, // Badminton text o slot ready
  ]; 
          ...
          <div className="animate-fade-in max-w-5xl mx-auto">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                ...
                <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden hover:border-[#7CD326] transition-all group flex flex-col">
                  ...
                  <div className="bg-[#1A0F2E] p-4 border-b-4 border-[#7CD326]">
                    <h3 className="text-white font-bold text-xl md:text-2xl font-serif">Post-Eid Football Tournament</h3>
          ...
          <div className="animate-fade-in max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              {filteredGallery.map((item) => (
                <div key={item.id} className="bg-white rounded-xl overflow-hidden shadow-md group border border-gray-100 hover:border-[#7CD326] transition-all">
                  <div className="h-52 overflow-hidden relative">
                    <img src={item.img} alt={item.title} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" onError={(e) => { e.target.src=`https://placehold.co/600x400/2D1B4E/7CD326?text=${item.title}` }} />
                  </div>
                  <div className="p-4 bg-[#1A0F2E]">
                    <span className="text-[#7CD326] text-[10px] uppercase font-bold tracking-widest">{item.category}</span>
                    <h4 className="text-white font-bold text-sm mt-1 font-serif">{item.title}</h4>
                  </div>
                </div>
              ))}
            </div>
...
{/* --- 📊 SPORTS ANALYTICS & STATS BOARD 📊 --- */}
          ...
          <div className="animate-fade-in max-w-5xl mx-auto">
                  ...
                  <table className="w-full text-left border-collapse text-xs md:text-sm">
                    <thead>
                      <tr className="bg-gray-100 border-b border-gray-200 text-[#2D1B4E] font-bold">
                        ...
                        <th className="p-3 text-center font-bold text-purple-900">PTS</th>
                      </tr>
                    </thead>
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-200 text-xs md:text-sm">
                <div className="p-5">
                  <h4 className="font-bold text-[#2D1B4E] border-b pb-2 mb-3 text-center uppercase text-xs tracking-wider">🔥 Leading Bowlers (Wickets)</h4>
                ...
                <div className="p-5">
                  <h4 className="font-bold text-[#2D1B4E] border-b pb-2 mb-3 text-center uppercase text-xs tracking-wider">🏏 Top Batsmen (Runs)</h4>
                  <div className="space-y-3">
                ...
                <div className="p-5">
                  <h4 className="font-bold text-[#2D1B4E] border-b pb-2 mb-3 text-center uppercase text-xs tracking-wider">🌟 Most Valuable Players / All Rounders</h4>
                  <div className="space-y-3">
        ...
        {/* --- 🤝 RESTORED COMPLETE SOCIAL WORK / CHARITY TAB 🤝 --- */}
        {activeTab === "charity" && (
          <div className="animate-fade-in max-w-5xl mx-auto">
             <div className="bg-[#2D1B4E] text-white py-12 px-6 text-center rounded-2xl mb-12 shadow-xl relative overflow-hidden">
             ...
             <div className="space-y-8 mb-12">
                ...
                {/* 2. Emergency Blood & Medical Support */}
      ...
      <footer className="bg-[#1A0F2E] text-gray-300 py-12 border-t-4 border-[#7CD326] mt-auto">
        <div className="max-w-[1200px] mx-auto px-4 md:px-8 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-sm leading-relaxed text-gray-400">A legacy of brotherhood, sports, and social development since 1985.</p>
          </div>
          <div>
            <h3 className="text-white text-lg font-bold mb-4 font-serif">Quick Links</h3>
            <ul className="space-y-2 text-sm text-gray-400">
              <li><button onClick={() => setActiveTab("home")} className="hover:text-[#7CD326]">Home Page</button></li>
              <li><button onClick={() => setActiveTab("events")} className="hover:text-[#7CD326]">Tournaments & Events</button></li>
              <li><button onClick={() => setActiveTab("gallery")} className="hover:text-[#7CD326]">Media Gallery</button></li>
              <li><button onClick={() => setActiveTab("stats")} className="hover:text-[#7CD326]">Stats Board</button></li>
              <li><Link href="/executive-team" className="hover:text-[#7CD326]">Our Executive Committee</Link></li>
            </ul>
          </div>
          <div>
        ...
        <div className="max-w-[1200px] mx-auto px-4 md:px-8 mt-10 pt-6 border-t border-gray-700/50 flex flex-col md:flex-row justify-between items-center text-xs text-gray-500">
          ...
          <p>Developed with ❤️ by <span className="text-[#7CD326] font-bold">Iftekhar Uddin Ahmed</span></p>
        </div>
      </footer>
